...
const models = [
  ...
  {
    stage: "04",
    name: "Hybrid Final Model",
    bpb: "1.65",
    size: "949 KB",
    description: "GRU + N-gram cache hybrid with int8 quantization and LZMA compression.",
    tech: ["Hybrid model", "N-gram cache", "4GB training", "1.62M params"],
    icon: Layers,
    status: "champion",
  },
];
